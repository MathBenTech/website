...
class WebsiteAccount(CustomerPortal):
    ...
    def portal_my_contacts(
        ...
        values = self._prepare_contacts_values(page, date_begin, date_end, search, sortby)
    ...
    def _contact_get_page_view_values(self, contact, access_token, **kwargs):
        ...
        # values = self._prepare_portal_layout_values(contact=contact)
        # values.update(
        #     {"contact": contact, "fields": self._contacts_fields(), 'page_name': 'contact', 'user': request.env.user}
        # )
        return self._get_page_view_values(contact, access_token, values, 'my_contact_history', False, **kwargs)
